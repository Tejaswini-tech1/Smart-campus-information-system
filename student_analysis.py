...
try:
    ...
    df = pd.read_excel("C:\\Users\\Admin\\OneDrive\\Desktop\\tejuuu\\DAY1\\python\\student_performance.cvs.xlsx")
    ...
    scores = df[["Math", "Chemistry", "Physics"]].to_numpy()
    ...
    top_chemistry = df.loc[df["Chemistry"].idxmax(), "Name"]
    top_physics = df.loc[df["Physics"].idxmax(), "Name"]

    print("\n--- Top Performers ---")

    print("Math:", top_math)
    print("Chemistry:", top_chemistry)
